...
<?php include('../layout/admin/menu.php');?>
  ...
  <div class="container">
        ...
        <?php
        $id_get = $_GET['id'];
        $query_rol = $pdo->prepare("SELECT * FROM tb_clientes WHERE id_cliente = '$id_get' AND  estado = '1' ");
        $query_rol->execute();
            ...
            <div class="col-md-6">
                <div class="card" style="border: 1px solid #AD52FE">
                    <div class="card-header" style="background-color: #D8ADFE">
                        <h4>¿Estás seguro de eliminar el Cliente?</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo $URL;?>/clientes/index.php" class="btn btn-default" >Cancelar</a>
                        </div>
                        <div id="respuesta">
...
<script>
    $('#btnborrar').click(function () {
        var id_cliente = <?php echo $id_get = $_GET['id'];?>
